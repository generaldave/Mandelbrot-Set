...
from .Constants import screen_resolution, app_title, fps
...
class App(object):
    ...
    def run_app(self):
        ...
        while running:
            ...
            if rendered == False:
                self.mandelbrot.update(self.screen, screen_resolution)
                self.mandelbrot.show(self.screen, screen_resolution)
                rendered = True
